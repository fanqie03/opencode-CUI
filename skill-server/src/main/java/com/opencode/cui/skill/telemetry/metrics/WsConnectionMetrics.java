...
/**
 * Unified WebSocket connection metrics for all WS endpoints in skill-server.
 *
 ...
 * <p>Tags:
 * <ul>
 *   <li>{@code url} — WS endpoint path (e.g. {@code /ws/skill/stream})</li>
 *   <li>{@code business} — business purpose (e.g. {@code miniapp-stream})</li>
